...
class ModelParams(ParamGroup): 
    def __init__(self, parser, config, sentinel=False):
        ...
        self.lazy_load_to_gpu = True
        self.eval = True
        self.split_mode = 'nvs-75'
        self.use_colmap = True
        self.default_order_downsample_ratio = 3
        self.num_cam = 1
        self.anchor_time_deformation = False
        ...
        self.order_args = dict(
            # bspline(ctrl_pts, order - 1), poly, fft, quat-spline(ctrl_pts, order - 1)
            xyz = [None, 5, 0, 6, 0, 0],
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser, config):
        ...
        self.opacity_reset_interval = 10_000
        self.densify_from_iter = 0 # 1000  # 500
        self.densify_until_iter = 30_000
        self.densify_scene_grad_threshold = 0.0002
        self.densify_obj_grad_threshold = 0.0002
        self.densify_persistence_gamma = 0.0
        self.data_sample = 'stack'

        self.position_deform_lr_scale = 0.2
        self.obj_position_lr_scale = 0.8
        self.object_extent = 10.0
        self.min_camera_extent = 10.0
        self.scene_position_lr_scale = 1.0

        self.rotation_deform_lr = 0.001
        self.shs_deform_lr = 0.0025
        self.env_lr = 1e-3
        self.gs_time_sigma_lr = 1e-2
        self.near_idx_reset_interval = 10
        self.near_num = 8
